...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TableCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI/RUC", "NOMBRE", "TELÉFONO", "DIRECCIÓN", "RAZON", "FECHA"
            }
        ));
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(textFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnGuardarCliente)
                    .addComponent(btnEditarCliente))
        ...
        jPanel3.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 270, 380));
        ...
        jLabel38.setText("Desarrollado por los alumnos de ISIC TEC");
        getContentPane().add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(656, 71, 410, 20));
    ...
    private void btnEditarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarClienteActionPerformed
        ...
        if ("".equals(txtIdCliente.getText())) {
            ...
            if (!"".equals(txtDniCliente.getText()) || !"".equals(txtNombreCliente.getText()) || !"".equals(txtTelefonoCliente.getText()) || !"".equals(txtDirecionCliente.getText()) || !"".equals(txtRazon.getText()) || !"".equals(textFecha.getText())) {
                cl.setDni(txtDniCliente.getText());
                cl.setNombre(txtNombreCliente.getText());
                cl.setTelefono(txtTelefonoCliente.getText());
                cl.setDireccion(txtDirecionCliente.getText());
                cl.setRazon(txtRazon.getText());
                cl.setFecha(textFecha.getText());
    ...
    private void TableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableClienteMouseClicked
        ...
        txtRazon.setText(TableCliente.getValueAt(fila, 5).toString());
        textFecha.setText(TableCliente.getValueAt(fila, 6).toString());
